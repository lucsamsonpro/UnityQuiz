...

{
    ...
    private int Index;
    public List<int> IndexMemory = new List<int>();
    ...
    //Déclaration tableau
    public string[] Quiz = new string[10];
    ...
    void Start()
    {
        ...
        Quiz[5] = "Dans la mythologie grecque, à quelle dynastie appartiennent Agamemnon, Ménélas, Oreste et Électre ?§Arkonènes§Atrides§Corinthos§Théleilas§Atrides";
    ...
    void Update()
    {
        TexteRightScore.text = "Bonnes réponses\n" + RightScore;
        TexteWrongScore.text = "Mauvaises réponses\n" + WrongScore;
